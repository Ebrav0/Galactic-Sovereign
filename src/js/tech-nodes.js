...
export const TECH_NODES = {
  ...
  dip_truce_protocol: node({
    ...
    description: 'Opens diplomacy after Dyson Maturity. Diplomacy stays on its own lane.',
    tags: ['diplomacy'],
  ...
  dip_galactic_council: node({
    ...
    description: 'Diplomacy capstone. Does not extend past the main path — Lattice Hegemony already merges into Live-Fire.',
