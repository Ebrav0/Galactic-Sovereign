...
export const TECH_NODES = {
  ...
  trade_mass_convoy_frames: node({
    id: 'trade_mass_convoy_frames', cluster: 'trade', name: 'Mass Convoy Frames',
    prereqs: ['trade_bulk_freighter'], creditCost: 1200, solariiCost: 2, researchMs: 62000,
    description: 'Standardized modular frames raise every convoy doctrine to 150% capacity.',
    unlocks: ['Convoy capacity +50%'],
    effects: [multiply('convoyCapacityMult', 1.5)],
  }),
  trade_sovereign_credit_arks: node({
    id: 'trade_sovereign_credit_arks', cluster: 'trade', name: 'Sovereign Credit Arks',
    prereqs: ['trade_mass_convoy_frames', 'trade_galactic_exchange'],
    creditCost: 1900, solariiCost: 4, researchMs: 78000,
    description: 'Empire-scale vault frames raise convoy capacity to 225% of doctrine baseline.',
    unlocks: ['Convoy capacity +50%'],
    effects: [multiply('convoyCapacityMult', 1.5)],
  }),
  trade_escort_coordination: node({
    id: 'trade_escort_coordination', cluster: 'trade', name: 'Escort Coordination',
    prereqs: ['trade_lane_secured', 'mil_patrol_cutter'],
    creditCost: 900, solariiCost: 1, researchMs: 56000,
    description: 'Reserve warships rally to convoy departures under a shared protection protocol.',
    unlocks: ['Convoy reserve coordination'],
    effects: [add('routeThreatReduction', 5)],
  }),
  trade_fortified_exchange: node({
    id: 'trade_fortified_exchange', cluster: 'trade', name: 'Fortified Exchange',
    prereqs: ['trade_escort_coordination', 'trade_armored_convoy'],
    creditCost: 1300, solariiCost: 2, researchMs: 65000,
    description: 'Unlocks Level 3 export centers with point defense and hardened vaults.',
    unlocks: ['Fortified Exchange upgrade'],
    effects: [add('routeThreatReduction', 10)],
  }),
  trade_convoy_point_defense: node({
    id: 'trade_convoy_point_defense', cluster: 'trade', name: 'Convoy Point Defense',
    prereqs: ['trade_fortified_exchange'], creditCost: 1500, solariiCost: 3, researchMs: 69000,
    description: 'Improves the security profile of every protected convoy.',
    unlocks: ['Convoy point-defense doctrine'],
    effects: [add('routeThreatReduction', 10)],
  }),
  trade_fast_couriers: node({
    id: 'trade_fast_couriers', cluster: 'trade', name: 'Fast Couriers',
    prereqs: ['trade_light_hauler'], creditCost: 850, solariiCost: 1, researchMs: 53000,
    description: 'Unlocks the Fast Courier export-center doctrine.',
    unlocks: ['Fast Courier doctrine'],
    effects: [set('unlockFastCourier', true)],
  }),
  trade_predictive_routing: node({
    id: 'trade_predictive_routing', cluster: 'trade', name: 'Predictive Routing',
    prereqs: ['trade_fast_couriers', 'trade_lane_secured'],
    creditCost: 1050, solariiCost: 1, researchMs: 58000,
    description: 'Combines sensor and patrol intelligence into safer route forecasts.',
    unlocks: ['Predictive route intelligence'],
    effects: [add('routeThreatReduction', 5)],
  }),
  trade_signature_masking: node({
    id: 'trade_signature_masking', cluster: 'trade', name: 'Signature Masking',
    prereqs: ['trade_predictive_routing'], creditCost: 1400, solariiCost: 3, researchMs: 68000,
    description: 'Unlocks the Stealth convoy doctrine.',
    unlocks: ['Stealth convoy doctrine'],
    effects: [add('routeThreatReduction', 5)],
  }),
  trade_credit_vaulting: node({
    id: 'trade_credit_vaulting', cluster: 'trade', name: 'Credit Vaulting',
    prereqs: ['trade_lane_secured'], creditCost: 900, solariiCost: 1, researchMs: 55000,
    description: 'Hardens export-center storage against raids and capture.',
    unlocks: ['Hardened export vaults'],
    effects: [set('creditVaulting', true)],
  }),
  trade_onsite_processing: node({
    id: 'trade_onsite_processing', cluster: 'trade', name: 'Onsite Processing',
    prereqs: ['trade_logistics_hubs', 'eco_industrial_automation'],
    creditCost: 1400, solariiCost: 2, researchMs: 66000,
    description: 'Deposits 10% of gross outpost output directly; the remaining 90% stays physical.',
    unlocks: ['10% onsite passive processing'],
    effects: [set('onsiteProcessingShare', 0.1)],
  }),
  trade_hardened_reserves: node({
    id: 'trade_hardened_reserves', cluster: 'trade', name: 'Hardened Reserves',
    prereqs: ['trade_credit_vaulting', 'trade_galactic_exchange'],
    creditCost: 1700, solariiCost: 3, researchMs: 72000,
    description: 'Level 4 export centers preserve more stored credits when overrun.',
    unlocks: ['Hardened reserve doctrine'],
    effects: [add('routeThreatReduction', 5)],
  }),
  ...
  trade_empire_doctrine: node({
    ...
    prereqs: [
      'trade_sovereign_credit_arks',
      'trade_convoy_point_defense',
      'trade_signature_masking',
      'trade_hardened_reserves',
      'trade_salvage_doctrine',
    ],
