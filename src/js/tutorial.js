...
export const TUTORIAL_STEPS = Object.freeze([
  ...
  },
  {
    ...
    objective: 'Press M, then use “Show me” to return to your home system.',
    controlActionId: 'toggle_view',
    why: 'Your Stronghold is the protected home system where this first empire begins.',
    expected: 'System view returns and the Stronghold badge is visible.',
    recovery: 'Choose “Show me”; Command will restore the home camera safely.',
...
function statusForStep(state, stepId, targetId) {
  ...
  const eventStatus = {
    ...
    system_return: 'Return to the Stronghold in System view.',
