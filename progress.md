...
- Committed the exact verified movement source as `96886d3` and deployed immutable release `multiplayer-stutter-96886d3-20260726-r1` through the guarded Proxmox/CT workflow.
- The deployment completed a 1.96 GB Proxmox snapshot, file-level world/release backup, checksum verification, production dependency audit, atomic release switch, service restart, and daily backup.
